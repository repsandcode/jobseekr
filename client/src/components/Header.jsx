    ...
    <div className="bg-[#f7fdfd]">
      ...
      >
        <div className="w-full z-10">
          ...
          {type && (
            <div className="w-full lg:1/2 flex justify-center flex-wrap gap-3 md:gap-4 py-10 md:py-14">
              {popularSearch.map((search, index) => (
                <span
                  key={index}
                  className="bg-[#1d4fd826] text-[#1d4ed8] py-1 px-4 rounded-full text-sm md:text-base"
                >
                  {search}
                </span>
              ))}
