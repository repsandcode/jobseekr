  ...
  return (
    <footer className="text-white mp-20">
      ...
      <div className="bg-[#1d4ed8]">
        ...
        <div className="">
          <p className="container px-5 mx-auto text-white mt-2 flex items-center justify-center md:justify-start ">
          ...
          <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between ">
            <div className="w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start ">
              <TextInput
                styles="w-full flex-grow md:w-80 2xl:w-64 bg-gray-100 md-2 text-[#001a36]"
                type="email"
              ...
              <CustomButton
                title="Subscribe"
                containerStyles={
                  "block bg-[#001a36] text-white px-5 py-2.5 text-md rounded hover:bg-blue-800 focus:potline-none flex-col items-center mt-3"
                }
              />
            </div>
