            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center ">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all ">
                  ...
                  <div className="w-full flex items-center justify-center py-4 gap-x-2">
                    <button
                      ...
                      <div className="w-full flex gap-1 md:gap-2">
                        ...
                        >
                          <TextInput
                            ...
                            placeholder={
                              accountType === "seeker" ? "Jack" : "JobMatch.ph"
                            }
                            type="text"
                            register={register(
                              accountType === "seeker" ? "firstName" : "name",
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-700">
                      ...
                      <span
                        className="text-sm text-blue-600 ml-1 hover:text-blue-700 hover:font-semibold cursor-pointer"
