      ...
      <div className="w-full flex flex-col md:flex-row gap-10">
        ...
        {isFetching ? (
          ...
          <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
            ...
            <div className="w-full flex flex-wrap md:flex-row gap-x-6 items-center justify-between my-10">
              <div className="bg-[#bdf4c8] mb-6 w-40 h-20 rounded-lg flex flex-col items-center justify-center">
              ...
              <div className="bg-[#bae5f4] mb-6 w-40 h-20 rounded-lg flex flex-col items-center justify-center">
              ...
              <div className="bg-[#fed0ab] mb-6 w-40 h-20 px-6 rounded-lg flex flex-col items-center justify-center">
              ...
              <div className="bg-[#cecdff] mb-6 w-40 h-20 px-6 rounded-lg flex flex-col items-center justify-center">
              ...
              <div className="bg-[#ffcdff] mb-6 w-40 h-20 px-6 rounded-lg flex flex-col items-center justify-center">
            ...
            <div className="my-6">
              {selected === "0" ? (
                <>
                  <p className="text-xl font-semibold">Job Desription</p>
        ...
        {/* RIGHT SIDE */}
        <div className="w-full md:w-1/3 2xl:w-2/4 p-5 mt-16 md:mt-0">
          <p className="text-gray-500 font-semibold mb-4">Similar Job Post</p>
