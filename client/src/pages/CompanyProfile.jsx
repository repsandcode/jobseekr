...
const CompanyForm = ({ open, setOpen }) => {
  ...
  const [errMsg, setErrMesg] = useState({ status: false });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (res.status === "failed") {
        ...
        setErrMesg({ status: "success", message: res.message });
  ...
  return (
    <div className="container mx-auto p-5">
      <div className="">
        ...
        <div className="w-full flex flex-col md:flex-row md:justify-between mt-4 md:mt-8 text-sm">
